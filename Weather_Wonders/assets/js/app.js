...
const searchTimeoutDuration = 500;  //serachTimeoutDuration
        ...
        */
        ...
        <h2 class="title-2" id="highlights-label">Todays Highlights</h2>
                        <div class="highlight-list">
                            ...
                            <div class="card card-sm highllight-card one">
                                <h3 class="title-3">Air Quality Index</h3>

                                <div class="wrapper">
                                    <span class="m-icon" style=" position: absolute;
                                    left: 25px;
                                    top: 90px;">air</span>

                                    <ul class="card-list">
                                        <li class="card-item" style=" position: absolute;
                                        left: 85px;
                                        top: 80px;">
                            ...
                            <div class="card card-sm highlight-card two">
                                ...
                                <div class="card-list">
                                    ...
                                    <div class="card-item" style="position: absolute;
                                    top: 60px;
                                    left: 290px;">
